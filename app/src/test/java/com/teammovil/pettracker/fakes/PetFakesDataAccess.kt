...
val fakePetList: MutableList<com.teammovil.domain.Pet> = listOf(
    com.teammovil.domain.Pet(
        "1",
        "Amber",
        ...
        com.teammovil.domain.PetType.DOG,
        false,
        listOf(
            com.teammovil.domain.Vaccine(
                "1",
                "Rabia 1",
            ...
            com.teammovil.domain.Vaccine(
                "2",
                "RTF",
                getDateFromString("2020-11-15")?.let { it } ?: Date()),
            com.teammovil.domain.Vaccine(
                "3",
                "Rabia 2",
        ...
        com.teammovil.domain.PetStatus.ADOPTED,
        listOf(
            com.teammovil.domain.Evidence(
                "1",
                "Su primer mes",
                "https://previews.123rf.com/images/seagames50/seagames501510/seagames50151000818/46862428-labrador-puppy-cute-one-month-old.jpg",
                getDateFromString("2020-09-15")?.let { it } ?: Date()),
            com.teammovil.domain.Evidence(
                "2",
                "Su 2do mes",
                "https://i.pinimg.com/originals/5f/4b/83/5f4b83282d834386a8ef3414a5cc3fb0.jpg",
                getDateFromString("2020-10-15")?.let { it } ?: Date()),
            com.teammovil.domain.Evidence(
                "3",
                "Su 3er mes",
                "https://s.abcnews.com/images/US/puppy-zoey-ht-jpo-171027_16x9_992.jpg",
                getDateFromString("2020-11-17")?.let { it } ?: Date()),
            com.teammovil.domain.Evidence(
                "4",
                "Su 4 mes",
